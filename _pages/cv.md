...
<i class="fas fa-phone"></i> 646 - 484 - 9881<br />
<i class="fas fa-at"></i> [{{ site.author.email }}](mailto:{{site.author.email}})<br />
<i class="fas fa-compass"></i> [https://keithmiyake.info](https://keithmiyake.info)<br />
{:.cv-intro}

<i class="fas fa-download"></i> [Download CV in PDF format]({{ '/assets/media/miyake-cv.pdf' | prepend: site.baseurl }})
{:.cv-intro}
